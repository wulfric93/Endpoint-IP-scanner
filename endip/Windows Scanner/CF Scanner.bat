...
if %menu%==0 exit
if %menu%==1 title CF Preferred WARP IP&set ipv4=162.159.192.0/24 188.114.98.0/24 188.114.96.0/24 188.114.99.0/24 162.159.195.0/24 8.34.146.0/24 8.35.211.0/24 8.34.70.0/24 8.39.204.0/24&goto getv4
